...
echo "2. 🌐 Navigate to: http://${LOCAL_IP}:${PORT}/web/vr.html?urdf=so101/so101"
...
echo "=================================================="
echo ""
echo "Web VR Interface: http://${LOCAL_IP}:$PORT/web/vr.html?urdf=so101/so101"
...
echo "1. Ensure the robot arm has clear workspace"
echo "2. Keep the emergency stop (B button) ready"
echo "3. Calibrate the arm home position if necessary"
echo ""
echo "=================================================="
...
echo "  • Moving Controller → Move Arm (X/Y/Z)"
echo "  • Grip Button (Hold) → Clutch (Direct Hand Tracking)"
echo "  • Index Trigger → Close Gripper"
echo "  • B Button → Emergency Stop"
echo "  • Y Button → Reset Home Position"
echo ""
echo "=================================================="
