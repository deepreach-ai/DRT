...
ROBOT_XML="${SCRIPT_DIR}/robots/rm75b/rm75b_vr_v2.xml"
EE_SITE="ee_site"
PORT=8000
...
echo "2. 🌐 Navigate to: http://${LOCAL_IP}:${PORT}/web/vr.html?urdf=rm75b/rm75b_w_gripper&virtual=1"
...
echo "2. Open the https://...ngrok-free.app/web/vr.html?urdf=rm75b/rm75b_w_gripper&virtual=1 URL in Quest"
echo ""
echo "=================================================="
echo -e "${BLUE}📊 Server URLs:${NC}"
echo "=================================================="
echo ""
echo "Web VR Interface: http://${LOCAL_IP}:$PORT/web/vr.html?urdf=rm75b/rm75b_w_gripper&virtual=1"
