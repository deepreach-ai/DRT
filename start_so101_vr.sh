#!/bin/bash
# VR Control Startup Script for SO-ARM101 in MuJoCo
# This script starts the teleoperation server with VR support for Quest 3S

set -e

echo "🤖 Starting SO-ARM101 VR Teleoperation System"
echo "=================================================="
echo ""
...
echo "   Robot Model: SO-ARM101 (6-DOF)"
...
# Note: We use the optimized 50Hz logic already implemented in the server
